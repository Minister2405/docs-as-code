...
The toolbar's `copy` and `view` options expose your page's Markdown content directly. If you use the [`Visibility`](/guides/visibility) component, the `for="agents"` blocks will be included in that Markdown — giving AI assistants structured context that human readers don't see.
